...
else if (mx >= width / 3 - width / 24 && mx <= width / 3 - width / 24 + width / 12 && my >= height * 2 / 3 - width / 24 && my <= height * 2 / 3 - width / 24 + width / 12) {
    return new TwoPlayerScene(this, renderer, width, height, filename);
}
else if (mx >= width * 2 / 3 - width / 24 && mx <= width * 2 / 3 - width / 24 + width / 12 && my >= height * 2 / 3 - width / 24 && my <= height * 2 / 3 - width / 24 + width / 12) {
